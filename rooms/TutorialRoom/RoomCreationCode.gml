...
with(instance_create_depth(0, 0, -200, obj_TextboxIntro)) {
		Text = "Discover 'Topics' by interacting with people, then link 'clues' found within the room to 'topics', to help repair their relationships. 'Space' to continue, 'Tab' for inventory, 'Click' to interact, 'A' & 'D' to Move";
